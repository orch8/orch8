...
export function RunEventCard({ event, baseTimestamp }: RunEventCardProps) {
  ...
  const { icon: defaultIcon, color } = EVENT_ICONS[event.eventType] ?? EVENT_ICONS.init;
  ...
  return (
    <div className="group flex gap-3">
      ...
      <div
        ...
        className="mb-3 flex-1 cursor-pointer rounded-md border border-zinc-800 bg-zinc-900/50 px-3 py-2 transition-colors hover:border-zinc-700"
      >
